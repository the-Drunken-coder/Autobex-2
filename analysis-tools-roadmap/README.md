...
1. ✅ **[Distance & Access Analysis](./01-distance-access-analysis.md)** - Calculate distances to parking/roads and show access routes *(Added)*
...
5. ❌ **[Street-Level Imagery](./05-street-level-imagery.md)** - Google Street View, Mapillary, and KartaView integration *(Removed)*
