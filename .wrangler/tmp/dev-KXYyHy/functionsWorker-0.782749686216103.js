...
// .wrangler/tmp/bundle-NxyNtB/checked-fetch.js
...
// .wrangler/tmp/bundle-NxyNtB/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-fxeC8A/functionsWorker-0.782749686216103.mjs
...
function parseOSMHistoryXml(xmlText, type) {
  ...
  let match2;
  while ((match2 = entryRegex.exec(xmlText)) !== null) {
    const entryText = match2[0];
...
function buildNewsLinks(name, address, lat, lon) {
  ...
  if (lat && lon)
    queryParts.push(`${lat.toFixed(4)}, ${lon.toFixed(4)}`);
...
// .wrangler/tmp/bundle-NxyNtB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-NxyNtB/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.782749686216103.js.map
