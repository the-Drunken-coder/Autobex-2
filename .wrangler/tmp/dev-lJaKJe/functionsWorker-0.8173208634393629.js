...
// .wrangler/tmp/bundle-UpGBZy/checked-fetch.js
...
// .wrangler/tmp/bundle-UpGBZy/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-2GTCXP/functionsWorker-0.8173208634393629.mjs
...
__name2(calculateDistanceMeters, "calculateDistanceMeters");
...
__name2(parseOSMHistoryXml, "parseOSMHistoryXml");
...
__name2(isValidCoordinates, "isValidCoordinates");
...
__name2(fetchOverpass, "fetchOverpass");
...
out center 60;`;
  ...
  const mapElement = /* @__PURE__ */ __name2((el) => ({
...
__name2(findAccessAndDistances, "findAccessAndDistances");
...
__name2(fetchHistoryData, "fetchHistoryData");
...
__name2(buildImageryLinks, "buildImageryLinks");
...
__name2(buildStreetViewLinks, "buildStreetViewLinks");
...
__name2(buildNewsLinks, "buildNewsLinks");
    ...
    try {
      ...
      if (res.ok) {
        ...
        pages.forEach((page) => {
          ...
          const strip = /* @__PURE__ */ __name2((val) => {
            if (!val)
              return null;
      ...
      if (res.ok) {
        ...
        titles.forEach((title, idx) => {
          result.wikipedia.push({
            title,
            url: urls22[idx] || `https://en.wikipedia.org/wiki/${encodeURIComponent(title.replace(/\s/g, "_"))}`,
            distance: null
          });
        });
      }
...
__name2(fetchWikimediaContent, "fetchWikimediaContent");
...
__name2(buildHistoryChanges, "buildHistoryChanges");
...
__name2(fetchWaybackReleases, "fetchWaybackReleases");
...
__name2(buildSatelliteComparison, "buildSatelliteComparison");
async function fetchNewsArticles(query) {
  ...
  const tasks = [];
  const parseRssItems = /* @__PURE__ */ __name2((xmlText) => {
    try {
...
__name2(fetchNewsArticles, "fetchNewsArticles");
...
__name2(buildAccessLines, "buildAccessLines");
...
// .wrangler/tmp/bundle-UpGBZy/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-UpGBZy/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8173208634393629.js.map
